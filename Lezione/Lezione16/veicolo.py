class Veicolo:
    ...
    metodo che stampa una descrizione del veicolo nel formato "Marca:
...
class Auto(Veicolo):
    ...
    Crea una classe derivata chiamata Auto che eredit
    dalla classe Veicolo e aggiunge i seguenti attributi e metodi:
...
class Moto(Veicolo):
    ...
    Crea una classe derivata chiamata Moto che eredita
    dalla classe Veicolo e aggiunge i seguenti attributi e metodi:
...
includere anche il tipo di moto nella descrizione, nel formato
